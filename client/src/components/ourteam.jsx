      ...
      <div className="teami m-3 d-flex justify-content-around w-100 mb-5">
        <div className="w-25">
          ...
          >
            <figure class="figure">
              <img
                src={require("../images/memberimage001.jpg")}
                class="imgm w-100"
                alt="member"
              />
     ...
     {/* content of off canva */}
      ...
      >
        ...
        <div class="offcanvas-body d-flex  flex-column ">
          <div className="w-100 m-2 d-flex justify-content-center mb-4">
            <img
              className="w-75"
              src={require("../images/memberimage001.jpg")}
              alt="member"
          ...
          <div>
            <p>
              Jogehn Smith is a Senior Software Engineer on our team. John has
              over 10 years of experience in software development and
              specializes in backend technologies. In his role, John is
              responsible for designing and implementing the core architecture
              of our software applications, ensuring they are scalable and
              efficient.
            </p>
            <p>
              One of John's key strengths is his ability to work collaboratively
              with other team members. He is an excellent communicator and
              always seeks feedback from his peers to ensure that the solutions
              he develops meet the needs of the entire team. John is also
              passionate about mentoring junior developers and has a proven
              track record of helping them grow and develop their skills
            </p>
          </div>
        </div>
      </div>
